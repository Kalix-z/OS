FLAGS = -ffreestanding -m32 -Ttext 1M -fno-pie -fno-rtti -mno-red-zone -fno-exceptions -fpermissive -I src/stl -I src/drivers -I src/kernel -I src/kernel/filesystem -I src/kernel/cpu -I src/kernel/cpu/idt -D __KERNEL_MODE_=1 -D _KERNEL_DEBUG=1
bin/Kernel.bin: bin/kmain.o bin/_start.o bin/multiboot_header.o bin/fat16.o bin/diskATA.o bin/memory.o bin/screen.o bin/io.o bin/keyboard.o bin/isr.o bin/gdt.o bin/gdtasm.o bin/idt.o bin/idtasm.o bin/functions.o
...
$(shell sudo dd if=bin/kernel.bin of=bin/image.img)
$(shell mv -f bin/image.img iso/boot/image.img)
$(shell grub-mkrescue -o bin/bootable.iso iso)
$(shell sudo fallocate -l 10485760 bin/bootable.iso -x)
$(shell cat bin/bootable.iso filesystem.img > boot.img)